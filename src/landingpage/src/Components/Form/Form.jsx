...
const Form = () => {
  ...
  return (
    <div className="my-20 bg-[#080719]">
      <section className="wrapper  text-white">
        <div
          data-aos="fade-up"
          className="max-w-5xl mx-auto -mb-[8rem] bg-[#080719] p-8 shadow-large shadow-black/10 rounded-lg relative z-10"
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-7 lg:gap-5">
            <div className="flex flex-col gap-3">
              ...
              <p data-aos="fade-up" className="max-w-[35rem] lg:max-w-max">
                ...
                solutions that drive business transformation. Contact us today
                to explore how our expertise can support your business goals.
              </p>
            </div>
            <form
            ...
            >
              <div className="grid sm:grid-cols-2 gap-5">
                <div className="flex flex-col">
                  ...
                  <input
                    type="text"
                    className="border outline-none border-main bg-black/5 rounded-lg p-2"
